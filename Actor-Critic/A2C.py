...
class A2C(object):
    ...
    def choose_action(self, s, deterministic):
        ...
        prob_weights = self.actor(s).detach().numpy().flatten()
        if deterministic:
    ...
    def learn(self, s, a, r, s_, dw):
        ...
        with torch.no_grad():   # TD error   dw: bool
            td_target = r + self.GAMMA * v_s_ * (1 - dw)
...
if __name__ == '__main__':
    ...
    writer = SummaryWriter(log_dir='runs/A2C/A2C_env_{}_number_{}_seed_{}'.format(env_name[env_index], number,
    ...
    while total_steps < max_train_steps:
        ...
        while not done:
            ...
            if (total_steps + 1) % evaluate_freq == 0:
                ...
                #     np.save('./data_train/A2C_env_{}_number_{}_seed_{}.npy'.format(env_name[env_index], number, seed),
